...
var AuthSignupComponent = /** @class */ (function () {
    function AuthSignupComponent(authService) {
    ...
    AuthSignupComponent.prototype.onSignup = function (form) {
        if (form.invalid) {
            return;
        }
        this.isLoading = true;
    ...
    AuthSignupComponent.prototype.ngOnDestroy = function () {
...
//# sourceMappingURL=auth-signup.component.js.map