...
export class ItemsListComponent implements OnInit {
  ...
  pageNo = 1; TotalItems;
  celldbclicked; oldArrow; fieldslable = []; sortOrder; headerField; totalPage;
  itemFrom = 0; ItemTO = 0;
  ...
  constructor(private itemsService: ItemsService, private router: Router, private route: ActivatedRoute, private projectService: ProjectsService, private eventEmitterService: EventEmitterService) {
