...
export class ListViewContainerComponent implements OnInit {
    ...
    computeHeader() {
        ...
        let i = 0;
        while (this.elems[i] !== undefined && (this.elems[i].listOffset - currentTop) <= 0) {
        ...
        if (this.topElement !== undefined && topElementBottom < this.topElement.headerHeight && topElementBottom > 0) {
