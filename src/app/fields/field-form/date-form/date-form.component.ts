...
export class DateFormComponent implements OnInit {
  ...
  createDateFormatOptions() {
    ...
    formatOptions.push({value: "MM/DD/YYY" , label: `Short (${moment(date).format("MM/DD/YYY")})`});
    formatOptions.push({value: "MM/DD/YYY" , label: `Short day before month (${moment(date).format("DD/MM/YYY")})`});
